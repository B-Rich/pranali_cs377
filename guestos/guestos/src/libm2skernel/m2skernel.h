...
struct mem_page_t {
  ...
  int valid_bit; // 1 : data is in data, 0 : data is in disk
  int init_flag; //set to 1 if page has been created. 
  uint32_t disk_block;
...
#define MAX_PAGE_IN_MEMORY 128
extern unsigned long count_page_in_memory;
extern unsigned long global_block_offset; 
